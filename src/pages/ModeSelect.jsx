    ...
    <div style={screenStyle}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '2.5rem', position: 'relative' }}>
        <div style={{
          ...
          gap: '3px', width: '36px', height: '36px', marginBottom: '0.75rem',
        }}>
          {[...Array(9)].map((_, i) => (
            <span key={i} style={{
              borderRadius: '2px',
      ...
      <div style={{
        ...
        gap: '1rem', width: '100%', maxWidth: '380px',
        position: 'relative',
      }}>
        {/* vs AI */}
        <button
        ...
        >
          ...
          <div style={{ textAlign: 'left', flex: 1 }}>
            ...
            <div style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.35)', lineHeight: 1.5 }}>
              Challenge the Minimax algorithm. Choose Easy, Medium, or Hard difficulty.
            </div>
          </div>
          <div style={{
            fontSize: '0.7rem', color: '#c8f04a',
            background: 'rgba(200,240,74,0.08)', border: '1px solid rgba(200,240,74,0.15)',
            padding: '0.2rem 0.6rem', borderRadius: '6px', whiteSpace: 'nowrap', flexShrink: 0,
          }}>vs AI</div>
        </button>
        ...
        >
          <div style={{
            width: '52px', height: '52px', borderRadius: '14px',
            background: 'rgba(126,242,200,0.08)', border: '1px solid rgba(126,242,200,0.2)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontSize: '1.6rem', flexShrink: 0,
          }}>👥</div>
          <div style={{ textAlign: 'left', flex: 1 }}>
            ...
            <div style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.35)', lineHeight: 1.5 }}>
              Two players, one device. Pass and play with a friend.
            </div>
          </div>
          <div style={{
            fontSize: '0.7rem', color: '#7ef2c8',
            background: 'rgba(126,242,200,0.08)', border: '1px solid rgba(126,242,200,0.15)',
            padding: '0.2rem 0.6rem', borderRadius: '6px', whiteSpace: 'nowrap', flexShrink: 0,
          }}>2 Players</div>
        </button>
